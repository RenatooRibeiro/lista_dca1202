//Q14. O que é um ponteiro para uma função? Pesquise na Internet referências sobre o assunto e
...
int main (void){
    ...
    int (*pf) (int) = &funcao;
    //Fornecendo o valor do parâmetro que será passado  e imprimindo o resultado
    printf("Valor = %d", pf(1));
}